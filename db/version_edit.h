...
{
  int refs;	                  //引用计数  
  int allowed_seeks;          // Seeks allowed until compaction(compact之前允许seek的次数)
...
/*
	...
	为了缩小Version切换的时间点，将这些操作封装成了VersionEdit，compact完成时，将VersionEdit中的操作一次应用
	到当前的Version即可得到最新状态的Version
*/
class VersionEdit 
{
 public:
 ...
 private:
  ...
  SequenceNumber last_sequence_; //最后用过的sequencenumber
